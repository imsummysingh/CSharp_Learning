...
//Abstract method exmaple
namespace _56_AbstractMethodExample
{
    ...
    abstract class Employee
    {
        ...
        public abstract string GetInsuranceAmount();
    ...
    class Manager : Employee        // inheriting from parent class with ":"
    {
        ...
        public override string GetInsuranceAmount()
        {
    ...
    class SalesMan : Employee
    {
        ...
        public override string GetInsuranceAmount()
        {
            return "Health Insurance Amount for Salesman is:" + 2000;
        }
    }
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(mgr.GetInsuranceAmount());
            ...
            Console.WriteLine(sm.GetInsuranceAmount());
