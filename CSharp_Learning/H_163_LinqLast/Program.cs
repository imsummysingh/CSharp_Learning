...
namespace H_163_LinqLast
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Last
            Employee eF = emp.Last(e => e.Job == "Cloud");
            Console.WriteLine("\nWith Last:");
            Console.WriteLine(eF.EmpId + ", " + eF.EmpName);


            //LastorDefault -> Will return null, if no mathcing element found.
            //will return null
            Console.WriteLine("\nWith LastorDefault:");
            Employee eE1 = emp.LastOrDefault(e => e.Job == "Security");
